...
QT_MOC_LITERAL(1, 12, 12), // "onMouseClick"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "QMouseEvent*"
QT_MOC_LITERAL(4, 39, 5) // "event"

    },
    "PlotManager\0onMouseClick\0\0QMouseEvent*\0"
    "event"
};
...
void PlotManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onMouseClick((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject PlotManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PlotManager.data,
      qt_meta_data_PlotManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
