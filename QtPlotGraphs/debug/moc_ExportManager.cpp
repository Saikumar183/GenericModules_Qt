...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ExportManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ExportManager_t qt_meta_stringdata_ExportManager = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ExportManager"
...
const QMetaObject ExportManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExportManager.data,
      qt_meta_data_ExportManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
